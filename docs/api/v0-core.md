...
1. A Bitbucket adapter for the shipped repository workflows. GitHub, Vercel, and Cloudflare adapters are shipped behind their provider-neutral capability contracts.
