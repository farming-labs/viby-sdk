...
1. A Bitbucket adapter for the shipped repository workflows, plus provider-neutral deployment workflows and vendor adapters. The GitHub App adapter is shipped.
