...
1. A Bitbucket adapter for the shipped repository workflows plus Vercel and Cloudflare adapters for the shipped provider-neutral deployment workflows. The GitHub App adapter is shipped.
