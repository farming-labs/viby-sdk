...
- sandbox, browser, artifact-store, HTTP hosting, preview lifecycle, and deployment credentials.
...
- SDK-owned preview hosting, deployments, provider connections, or GitHub export.
