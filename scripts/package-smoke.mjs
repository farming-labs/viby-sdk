...
try {
  ...
  await execute(
    ...
    [
      ...
      "--eval",
      [
        'import { accessibilityGate, builtInFrameworks, configuredIntegrations, consoleErrorGate, createViby, frameworkSkill, BrowserSession, DeploymentIntegrationHandle, DownloadArtifact, IntegrationAuthorizationError, IntegrationClient, IntegrationOperationError, RepositoryIntegrationHandle, SandboxSession, SourceImportError, generationEventStreamResponse, openBrowserSession, openTelemetry, signedOutboundEventSink, verifySignedOutboundEvent, skillRead } from "@viby/sdk";',
  ...
  await execute(
    ...
    [
      ...
      "--eval",
      [
        'import { MESSAGE_PART_TYPES, defineSkillResolver, generationEventCursor } from "@viby/sdk/core";',
