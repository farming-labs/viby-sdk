...
const operations = [
  ...
  operation("listQueuedGenerations", "get", "/chats/{chatId}/queue", "List queued follow-up generations", "Generations"),
  operation("enqueueGeneration", "post", "/chats/{chatId}/queue", "Queue a generation after a predecessor", "Generations", 202, "json", "EnqueueGenerationRequest"),
  ...
  operation("listWebhooks", "get", "/webhooks", "List durable webhooks", "Webhooks"),
  operation("createWebhook", "post", "/webhooks", "Create a durable webhook", "Webhooks", 201, "json", "CreateWebhookRequest"),
  operation("getWebhook", "get", "/webhooks/{webhookId}", "Get a durable webhook", "Webhooks"),
  operation("updateWebhook", "patch", "/webhooks/{webhookId}", "Update a durable webhook", "Webhooks", 200, "json", "UpdateWebhookRequest"),
  operation("deleteWebhook", "delete", "/webhooks/{webhookId}", "Delete a durable webhook", "Webhooks"),
  operation("pauseWebhook", "post", "/webhooks/{webhookId}/pause", "Pause a durable webhook", "Webhooks"),
  operation("resumeWebhook", "post", "/webhooks/{webhookId}/resume", "Resume a durable webhook", "Webhooks"),
  operation("rotateWebhookSecret", "post", "/webhooks/{webhookId}/rotate-secret", "Rotate a webhook signing secret", "Webhooks"),
  operation("deliverWebhookEvents", "post", "/webhooks/{webhookId}/generations/{generationId}/deliver", "Deliver durable generation events", "Webhooks", 200, "json", "WebhookDeliveryRequest"),
  operation("listWebhookDeliveries", "get", "/webhooks/{webhookId}/generations/{generationId}/deliveries", "List webhook delivery records", "Webhooks"),
  operation("redriveWebhookDelivery", "post", "/webhooks/{webhookId}/generations/{generationId}/deliveries/{cursor}/redrive", "Redrive a webhook dead letter", "Webhooks"),
...
const schemaDefinitions = {
  ...
  EnqueueGenerationRequest: objectSchema({
    prompt: { type: "string", minLength: 1, maxLength: 100_000 },
    afterGenerationId: identifier,
  }, ["model", "engine", "instructions", "skills", "metadata", "attachments"]),
  MessageFeedbackRequest: objectSchema({ rating: { enum: ["positive", "negative"] } }, ["reasons", "comment", "metadata", "idempotencyKey"]),
  CreateWebhookRequest: objectSchema({
    name: { type: "string", minLength: 1, maxLength: 100 },
    url: { type: "string", format: "uri" },
  }, ["events", "signingSecret"]),
  UpdateWebhookRequest: objectSchema({}, ["name", "url", "events"]),
  WebhookDeliveryRequest: objectSchema({}, ["limit", "retry"]),
